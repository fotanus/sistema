	...
	function initJSandCSS() {
		echo <<<SCRIPTS
			...
			<style type="text/css">
				...
				/* array */
				table.dBug_array { background-color:#FF6600; }
				table.dBug_array td { background-color:#FFFFFF; }
				table.dBug_array td.dBug_arrayHeader { background-color:#FF9900; }
				table.dBug_array td.dBug_arrayKey { background-color:#FFCC66; }
