...
<div class="container_12 fk-main-container">
    ...
    ?>
    <div class="grid_10">
        <div class="grid_10 alpha omega"><h3>Producto Nuevo</h3></div>
        ...
        <div class="grid_6 alpha">
            <div class="fk-forma" style="max-width: none;">
                ...
                <label>Precio<input type="text" placeholder="Precio" id="selImagen"></label>
                <input type="text" placeholder="Titulo" id="tituloProducto">
                <input type="text" placeholder="Precio" id="selImagen">
            </div>
        </div>
